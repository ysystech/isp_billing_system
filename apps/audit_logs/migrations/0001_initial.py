# Generated by Django 5.2.2 on 2025-06-29 07:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['ip_address'], name='audit_logs__ip_addr_f24bd2_idx'), models.Index(fields=['created_at'], name='audit_logs__created_de8c9b_idx')],
            },
        ),
    ]
